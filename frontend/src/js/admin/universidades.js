    ...
    () => {
        ...
        const rows =
            document.querySelectorAll(
                "#universitiesTableBody tr[data-name]"
            );
        ...
        if (modalVisualizar) {
            ...
            modalVisualizar.addEventListener(
                ...
                event => {
                    ...
                    const sigla =
                        button.dataset.sigla;


                    const cidade =
                        button.dataset.cidade;
        ...
        const deleteName =
            document.getElementById(
                "deleteUniversityName"
            );


        const deleteForm =
            document.getElementById(
                "deleteUniversityForm"
            );
